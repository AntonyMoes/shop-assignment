...
namespace _Game.Scripts.UI.DragAndDrop {
    public class DropComponent : MonoBehaviour, IDropHandler {
        ...
        private Func<DragComponent, DragComponent, bool> _canDrop;
        ...
        public void Init(Func<DragComponent, DragComponent, bool> canDrop = null) {
            _canDrop = canDrop;
        }
        ...
        public void OnDrop(PointerEventData eventData) {
            ...
            var canDrop = (_canDrop?.Invoke(dragComponent, DragComponent) ?? true) &&
                          (dragComponent.DropComponent == null || DragComponent == null ||
                           (dragComponent.DropComponent._canDrop?.Invoke(DragComponent, dragComponent) ?? true));
